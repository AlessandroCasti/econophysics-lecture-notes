...
$P,\ Q$ & historical and risk-neutral measures in the Bj\"ork supplement \\
$L_t,\ \varphi_t,\ W_t^Q$ & likelihood process, Girsanov kernel and $Q$-Wiener process \\
$B_t,\ \Pi_t[X]$ & bank account and claim price in that supplement (not the bond $B$ or cash $\Pi$ elsewhere) \\
...
$v,\ \sigma$ & variance and vol-of-vol in the Heston pricing section (instantaneous stock volatility is $\sqrt v$) \\
...
$A(r),\ B(r)$ & drift and diffusion of the income Fokker--Planck equation
  (sign convention: $E[dr\mid r]=-A(r)\,dt$ away from a reflecting boundary) \\
